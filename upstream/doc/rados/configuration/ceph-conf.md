...
Each of the configuration options associated with a single process or
...
In this example, the value of the \"`obscure one`\" option is
...
In commands that specify a configuration option, the argument of the
