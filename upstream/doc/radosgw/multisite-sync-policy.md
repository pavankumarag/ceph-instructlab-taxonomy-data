# Multisite Sync Policy {#radosgw-multisite-sync-policy}
...
Where zones are a comma separated list of all the zones that need to add
to the flow.
...
This is similar to older (pre `Octopus`) sync capabilities, but being
