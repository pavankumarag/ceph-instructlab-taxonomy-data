...
[Mirroring]{.title-ref} module (manager plugin) provides interfaces for
...
Commands to check directory mapping (to mirror daemons) and directory
...
Command with [fs mirror peer status]{.title-ref} prefix provide peer
