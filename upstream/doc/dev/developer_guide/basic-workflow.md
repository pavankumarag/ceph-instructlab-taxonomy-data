# Basic Workflow {#basic workflow dev guide}
...
You must fork the Ceph repository before you clone it. If you fail to
...
### Fixing the bug in the local working copy {#fixing_bug_locally}
