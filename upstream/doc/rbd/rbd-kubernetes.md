...
The provisioner and node plugin YAMLs will, by default, pull the
...
Using [ceph-csi]{.title-ref}, specifying [Filesystem]{.title-ref} for
...
To create a file-system-based [PersistentVolumeClaim]{.title-ref} that
