...
See [Create a Pool](../../rados/operations/pools#createpool) for detail
...
Nodes running `nova-compute` need the keyring file for the
...
You can use [qemu-img](../qemu-rbd/#running-qemu-with-rbd) to convert
