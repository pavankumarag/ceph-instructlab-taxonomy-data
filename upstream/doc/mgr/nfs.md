# CephFS & RGW Exports over NFS {#mgr-nfs}
...
`<cluster_id>` is an arbitrary string by which this NFS Ganesha cluster
...
For example, if the NFS cluster was created with
...
## Manual Ganesha deployment {#nfs-ganesha-config}
