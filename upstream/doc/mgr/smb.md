# File System Shares Over SMB {#mgr-smb}
...
Each individual resource description must belong to one of the types
described below.
...
A Ceph cluster operator wanting to quickly test a share is functioning
